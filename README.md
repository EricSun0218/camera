...
4. Edit `app/Cue/LLM/BackendClient.swift` — set `BackendClient.baseURL` to your deployed Vercel URL
...
3. Production URL → paste into `app/Cue/LLM/BackendClient.swift`: `BackendClient.baseURL`
